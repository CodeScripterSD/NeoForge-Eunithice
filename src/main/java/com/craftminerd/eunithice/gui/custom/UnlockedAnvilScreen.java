...
@OnlyIn(Dist.CLIENT)
public class UnlockedAnvilScreen extends ItemCombinerScreen<UnlockedAnvilMenu> {
    ...
    public UnlockedAnvilScreen(UnlockedAnvilMenu menu, Inventory playerInventory, Component title) {
    ...
    private void onNameChanged(String name) {
        ...
        if (slot.hasItem()) {
            ...
            if (this.menu.setItemName(newname)) {
                PacketDistributor.sendToServer(new RenameItemPacket(newname));
            }
        }
    }
